...
def welcome (nome_jogador):
    ...
    print("Após a queda da Igreja na capital, o caos foi se espalhando, e o mundo foi dominado pelo {}, aos poucos e agora cabe a você salvar o Reino.\nVocê deve fazer suas escolhas com honra e sabedoria, pois elas afetaram diretamente a sua jornada. Que a força esteja com você...".format(personagens[0]))
...
def aceitou_ajuda():
    print("Ótima decisão! Agora, o {} é seu amigo e lhe forneceu uma de suas melhores armaduras.".format(personagens[0]))
    print("Você obteve 20 pontos incrementados na sua vida, entretanto, o {} irá lhe acompanhar em sua jornada até a capital e irá atrasar sua viajem.".format(personagens[1]))
    jogador['vida'] += 20

def negou_ajuda():
    print("Você negou ajuda, sua jornada continuará, entretanto, o {} não lhe ajudará, e, você deixou de ganhar recompensas.".format(personagens[0]))
